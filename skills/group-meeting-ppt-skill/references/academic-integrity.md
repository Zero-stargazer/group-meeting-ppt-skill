...
This skill helps with structure, preparation, and review. It must not be used to fabricate content.

## Allowed

- Summarize user-provided paper content.
- Turn verified facts into a slide outline.
...
- Write a final presentation that hides uncertainty.
